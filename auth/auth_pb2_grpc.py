...
class AuthServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.VerifyAccess = channel.unary_unary(
                '/hospital.auth.AuthService/VerifyAccess',
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hospital.auth.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hospital.auth.AuthService', rpc_method_handlers)
